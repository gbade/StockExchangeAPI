...
namespace XOProject.Api.Controller
{
    ...
    public class ShareController : ControllerBase
    {
        ...
        public async Task<IActionResult> Post([FromBody]HourlyShareRateModel value)
        {
            ...
            var sharerate = await _shareService.GetHourlyAsync(value.Symbol, value.TimeStamp);

            if (sharerate != null)
                return BadRequest($"Hourly Share Rate already exists for {value.Symbol} at {value.TimeStamp}");
